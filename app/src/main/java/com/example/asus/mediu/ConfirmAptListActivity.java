...
public class ConfirmAptListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPatientUsersDatabase = FirebaseDatabase.getInstance().getReference().child("Patient_Users").child(mCurrent_user.getUid()).child("Appointments").child("Confirm");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<AptSingle, AptViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<AptSingle, ConfirmAptListActivity.AptViewHolder>(
                AptSingle.class, R.layout.activity_apt_request_received_list_single, ConfirmAptListActivity.AptViewHolder.class, mPatientUsersDatabase
        ) {
            @Override
