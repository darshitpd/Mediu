                    ...
                    mUserDatabase.child("age").setValue(age).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                mProgressDialog.dismiss();
                                Toast.makeText(PatientProfile.this, "Error in saving data.",
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                StorageReference filepath = mImageStorage.child("patient_profileimage").child(current_user_id+".jpg");
                final StorageReference thumbnail_filepath = mImageStorage.child("patient_profileimage").child("thumbs").child(current_user_id+".jpg");
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                                    ...
                                    if(thumb_task.isSuccessful()){
                                        ...
                                        mUserDatabase.updateChildren(update_hashmap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                mProgressDialog.dismiss();
                                                Toast.makeText(PatientProfile.this, "Upload successful.",
                                                        Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }else
                                    {
                                        mProgressDialog.dismiss();
                                        Toast.makeText(PatientProfile.this, "Error in uploading the thumbnail.",
                                                Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(PatientProfile.this, "Error in uploading the image.",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
