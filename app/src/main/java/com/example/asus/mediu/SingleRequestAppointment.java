...
public class SingleRequestAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPatientDatabase= FirebaseDatabase.getInstance().getReference().child("Patient_Users").child(mCurrentUser.getUid()).child("Appointments").child("Request").child(apt_id);
        ...
        mDecline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDocDatabase.child(doctor_id).child("Appointments").child("Request").child(apt_id).removeValue();
                ...
                startActivity(new Intent(SingleRequestAppointment.this, appointmentActivity.class));
            }
        });
    }
}
